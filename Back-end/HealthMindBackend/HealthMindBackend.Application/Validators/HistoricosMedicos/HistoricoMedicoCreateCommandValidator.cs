...
{
    public class HistoricoMedicoCreateCommandValidator : AbstractValidator<HistoricoMedicoCreateCommand>
    {
        private readonly IPacienteRepository _pacienteRepository;
        private readonly IProntuarioRepository _prontuarioRepository;

        public HistoricoMedicoCreateCommandValidator(IPacienteRepository pacienteRepository, IProntuarioRepository prontuarioRepository)
        {
