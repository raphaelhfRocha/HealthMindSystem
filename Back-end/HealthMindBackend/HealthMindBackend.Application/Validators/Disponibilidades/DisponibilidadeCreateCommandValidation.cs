...
{
    public class DisponibilidadeCreateCommandValidation : AbstractValidator<DisponibilidadeCreateCommand>
    {
        private readonly IPsicologoRepository _psicologoRepository;

        public DisponibilidadeCreateCommandValidation(IPsicologoRepository psicologoRepository)
        {
