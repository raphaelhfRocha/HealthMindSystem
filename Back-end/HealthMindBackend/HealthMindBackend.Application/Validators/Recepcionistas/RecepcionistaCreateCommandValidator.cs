...
{
    public class RecepcionistaCreateCommandValidator : AbstractValidator<RecepcionistaCreateCommand>
    {
        private readonly IRecepcionistaRepository _recepcionistaRepository;

        public RecepcionistaCreateCommandValidator(IRecepcionistaRepository recepcionistaRepository)
        {
