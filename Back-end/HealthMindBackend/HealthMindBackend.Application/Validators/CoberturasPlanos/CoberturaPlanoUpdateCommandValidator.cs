...
{
    public class CoberturaPlanoUpdateCommandValidator : AbstractValidator<CoberturaPlanoUpdateCommand>
    {
        private readonly IPlanoSaudeRepository _planoSaudeRepository;

        public CoberturaPlanoUpdateCommandValidator(IPlanoSaudeRepository planoSaudeRepository)
        {
            ...
            RuleFor(c => c.Especialidade)
                ...
                .MustAsync(async(command, none, cancellationToken) =>
                {
                    ...
                    return coberturaPlanoFound == null || coberturaPlanoFound.Especialidade == command.Especialidade;
