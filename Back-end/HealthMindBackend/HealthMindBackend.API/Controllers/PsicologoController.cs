...
namespace HealthMindBackend.API.Controllers
{
    ...
    public class PsicologoController : ControllerBase
    {
        ...
        /// <summary>
        /// Lista de psicólogo por Nome
        /// </summary>
        /// <response code="200">Psicólogos encontradas</response>
        /// <response code="400">Dados inválidos</response>
        /// <response code="404">Psicólogos não encontradas</response>
        /// <response code="500">Erro interno</response>
        /// <remarks>
        ...
        public async Task<IActionResult> GetPsicologosByNome(String nome)
        {
            ...
            var result = await _psicologoService.GetPsicologosByNome(nome);
            return Ok(result);
        }
        /// <summary>
        /// Lista de psicólogo por Especialidade
        /// </summary>
        /// <response code="200">Psicólogos encontradas</response>
        /// <response code="400">Dados inválidos</response>
        /// <response code="404">Psicólogos não encontradas</response>
        ...
        /// Como usar:
        /// 
        /// **1. Digite o Nome do psicólogo registrado no campo do parâmetro especialidade**
        /// 
        /// **2. Em seguida clique no botão Execute**
        /// 
        /// **[GET] - /api/Psicologo/{nome}**
        ...
        public async Task<IActionResult> GetPsicologosByEspecialidade(String especialidade)
        {
            ...
            var result = await _psicologoService.GetPsicologosByEspecialidade(especialidade);
            return Ok(result);
        }
        /// <summary>
